...
@Service
public class ZhonganLoanApplyResultRetriever extends ResponsibilityHandler {

    private static final Logger LOG = LoggerFactory.getLogger(ZhonganLoanApplyResultRetriever.class);
